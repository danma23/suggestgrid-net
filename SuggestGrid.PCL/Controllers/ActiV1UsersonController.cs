...
{
    public partial class ActiV1UsersonController: BaseController
    {
        #region Singleton Pattern

        //private static variables for the singleton pattern
        private static object syncObject = new object();
        private static ActiV1UsersonController instance = null;

        /// <summary>
        /// Singleton pattern implementation
        /// </summary>
        internal static ActiV1UsersonController Instance
        {
            get
            {
                lock (syncObject)
                {
                    if (null == instance)
                    {
                        instance = new ActiV1UsersonController();
                    }
                }
                return instance;
            }
